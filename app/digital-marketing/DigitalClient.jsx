    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen pt-30 text-center bg-gradient-to-br from-blue-50 to-white">
        ...
        <p className="text-gray-700 text-lg mb-10 max-w-xl px-4">
          Practice quizzes for SEO, Social Media Marketing, Google Ads, Email Marketing,  
          Analytics, and complete Digital Marketing modules are coming soon!  
          Improve your skills with interactive MCQs, mock tests, and real-world case studies.
        </p>
